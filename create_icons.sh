...
EOF
echo "✅ icon_settings.svg erstellt."
...
EOF
echo "✅ icon_drag_and_drop.svg erstellt."


echo "---"
echo "Alle Icons wurden erfolgreich hinzugefügt."